...
void quantize_lcu_luma_residual(encoder_state_t *encoder_state, int32_t x, int32_t y, uint8_t depth, cu_info *cur_cu, lcu_t* lcu);
void quantize_lcu_chroma_residual(encoder_state_t *encoder_state, int32_t x, int32_t y, uint8_t depth, cu_info *cur_cu, lcu_t* lcu);
