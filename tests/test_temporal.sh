...
# With gop 8
temporal_test 264x130 30 0 --preset=ultrafast --gop=t8 -p0
temporal_test 264x130 30 1 --preset=ultrafast --gop=t8 -p0
temporal_test 264x130 30 2 --preset=ultrafast --gop=t8 -p0
temporal_test 264x130 30 3 --preset=ultrafast --gop=t8 -p0
temporal_test 264x130 30 4 --preset=ultrafast --gop=t8 -p0
